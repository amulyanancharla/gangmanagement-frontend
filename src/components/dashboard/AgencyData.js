    ...
    return (
      <Grid item xs={12} sm={6} md={4}>
        <Paper style={{ padding: "20px" }}>
          ...
          <TabPanel value={gangTab} index={1} label="value"></TabPanel>
        </Paper>
      </Grid>
    );
  }
    ...
    return (
      <Grid item xs={12} sm={6} md={4}>
        <Paper style={{ padding: "20px" }}>
          ...
          <TabPanel value={IntelligenceTab} index={1} label="value"></TabPanel>
        </Paper>
      </Grid>
    );
  }
    ...
    return (
      <Grid item xs={12} sm={6} md={4}>
        <Paper style={{ padding: "20px" }}>
          ...
          <TabPanel value={addressTab} index={1} label="value"></TabPanel>
        </Paper>
      </Grid>
    );
  }
    ...
    async function getLabels() {
      ...
      try {
        const response = await agencyApi({
          path: `agency/${authStore.agencyInfo.agency_id}/labels`,
          method: "GET",
        });
        setPersonLabels(
